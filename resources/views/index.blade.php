...
<html lang="en">
  ...
  <body>
    ...
    <section class="ftco-section" id="GuestStar">
    	<div class="container" >
    		<div class="row justify-content-center mb-5 pb-3">
				<div class="col-md-7 text-center heading-section ftco-animate">
						<div class="text-center">
							<div class="wm wow slideInUp animated " >GUESTSTAR</div>
							<h2 class="wow fadeInUp text-white" data-wow-delay=".2s" ><span class="id-color"></span> GUESTSTAR</h2>
    		...
    		<div class="row justify-content-center mb-5 pb-3">
				<div class="col-md-7 text-center heading-section ftco-animate">
					<div class="text-center">
						...
						<h2 class="wow fadeInUp text-white" data-wow-delay=".2s" ><span class="id-color"></span> TICKET</h2>
						<div class="small-border bg-color-2"></div>
						<div class="spacer-single"></div>
					</div>
				</div>
        		...
        		<div class="carousel-testimony owl-carousel">
					...
					<div class="pricing-s1 mb-sm-30 wow flipInY">
						...
						<div class="action text-center">
							<a type="button" href="@guest {{route('login')}} @else {{route('ticketPage')}} @endguest" class="btn btn-danger btnModal"
							style="border-radius: 40px;" data-bs-toggle="modal" data-bs-target="#beliTicket">
							Buy Ticket
						</a>
...
@endforeach
        ...
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
			<div class="text-center">
				...
				<h2 class="wow fadeInUp text-white" data-wow-delay=".2s" ><span class="id-color"></span> POST</h2>
				<div class="small-border bg-color-2"></div>
				<div class="spacer-single"></div>
			</div>
          </div>
		  ...
		  <div class="row justify-content-center mb-5 pb-3">
			<div class="col-md-7 heading-section text-center ftco-animate">
			  <div class="text-center">
				  ...
				  <h2 class="wow fadeInUp text-white" data-wow-delay=".2s" ><span class="id-color"></span>SPONSORED</h2>
				  <div class="small-border bg-color-2"></div>
				  <div class="spacer-single"></div>
			  </div>
			</div>
			...
			<div class="row justify-content-center mb-5 pb-3">
			  <div class="col-md-7 heading-section text-center ftco-animate">
				<div class="text-center">
					...
					<h2 class="wow fadeInUp text-white" data-wow-delay=".2s" ><span class="id-color"></span>MEDPART</h2>
					<div class="small-border bg-color-2"></div>
					<div class="spacer-single"></div>
				</div>
			  </div>
    ...
    <footer id="footer">
		<div class="footer-top pt-5">
			<div class="container">
				<img src="images/logo_polije.png" width="100px" class="img-fluid mr-3">
				<img src="images/logo_jti.png" width="100px" class="img-fluid mr-3">
				<img src="images/logo_hmjti.png" width="100px" class="img-fluid">
				...
				<div class="row mt-3">
					...
					<div class="col-lg-3 col-md-6 footer-links">
						...
						<ul>
							<li><i class="bx bx-chevron-right"></i> <a href="#" class="text-white">Beranda</a></li>
					...
					<div class="col-lg-3 col-md-6 footer-links text-white">
						...
						<ul class="text-white">
							<li><i class="bx bx-chevron-right"></i> <a href="https://www.polije.ac.id" class="text-white">Politeknik Negeri
									Jember</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="https://www.jti.polije.ac.id" class="text-white">Jurusan Teknologi
									Informasi POLIJE</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="https://www.instagram.com/bempolije" class="text-white">BEM KM
									POLIJE</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="https://www.hmjtipolije.com" class="text-white">Himpunan Mahasiswa
