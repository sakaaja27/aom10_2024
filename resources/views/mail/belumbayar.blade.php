                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    <a href="#"><img style="height: 70px" src="{{ asset('img/logo aom.png') }}"
                                            alt="logo"></a>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 15px 30px;">
                                    <img style="width:88px; margin-bottom:24px;" src="{{ asset($data['img']) }}"
                                        alt="Verified">
                                    <h2
                                        style="font-size: 18px; color: {{ $data['color'] }}; font-weight: 400; margin-bottom: 8px;">
                                        Pembelian Tiket Art Of Manunggalan 10 {{ $data['text'] }}.</h2>
                                    <p>{{ $data['text2'] }}</p>
                                </td>
                            </tr>
                            <tr>
