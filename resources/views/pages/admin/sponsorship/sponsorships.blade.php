            ...
            <div class="block-header block-header-default">
                ...
                <div class="block-options ">
                    <button data-bs-target="#tambahsponsor" data-bs-toggle="modal" type="button" class="btn btn-primary">
                        <i class="fa fa-fw fa-plus me-1"></i> tambah sponsor
                    </button>
                </div>
            </div>
                ...
                <table class="table table-hover table-bordered  table-vcenter js-dataTable-full-pagination">
                    <thead>
                        <tr>
                            ...
                            <th>nama Sponsor</th>
                            <th class="d-none d-sm-table-cell">Categori Sponsor</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('admin.sponsorship.destroy', $sponsorship->id) }}"
                                        ...
                                        @method('delete')
                                        <div class="btn-group">
                                            <a type="button" href="{{ route('admin.sponsorship.edit', $sponsorship->id) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Tambah Sponsorship</h3>
                        <div class="block-options">
                        ...
                        <div class="block-content">
                            ...
                            <div class="mb-2">
                                ...
                                <select class="js-select2 form-select" id="id_sponsorship_categori"
                                    ...
                                    <option selected disabled>Kategori Sponsorship</option>
                                    <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                    @foreach ($sponsorshipscategoriesdata as $sponsorshipscategori)
                                        <option value="{{ $sponsorshipscategori->id_sponsorship_categori }}">
